package DGHR_Eurostat.Services;
...

{
	...
	final static Generic _instance = new Generic();

	static Generic _newInstance() { return new Generic(); }

	static Generic _cast(Object o) { return (Generic)o; }
        ...
        throws ServiceException
	{
		...
		// [i] recref:1:required dimension Documents:dimension
